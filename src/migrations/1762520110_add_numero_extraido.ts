...
export class AddNumeroExtraido1730988000000 implements MigrationInterface {
    ...
    public async up(queryRunner: QueryRunner): Promise<void> {
        ...
        try {
            await queryRunner.query(`DROP INDEX IF EXISTS "IDX_numero_nic_laudo_auto"`);
        } catch (error) {
        ...
        await queryRunner.addColumn("desarquivamentos", new TableColumn({
        ...
        await queryRunner.createIndex("desarquivamentos", new TableIndex({
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        ...
        await queryRunner.dropIndex("desarquivamentos", "IDX_numero_nic_laudo_auto");

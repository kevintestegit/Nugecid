...
export class AddIndexesToInstitutoRequerente1733754977000 implements MigrationInterface {
    ...
    public async down(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_desarquivamento_requerente"`);
        await queryRunner.query(`DROP INDEX IF EXISTS "IDX_desarquivamento_instituto"`);
    }
}

...
export class TarefasController {
  ...
  // ========== NOVOS ENDPOINTS DE FILTROS AVANÇADOS ==========

  @Get("filtros/buscar")
  @ApiOperation({ summary: "Buscar tarefas com filtros avançados" })
  @ApiResponse({
    status: 200,
  ...
  @Get("filtros/estatisticas")
  @ApiOperation({ summary: "Estatísticas de tarefas com filtros" })
  @ApiResponse({
    status: 200,

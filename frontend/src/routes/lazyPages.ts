...
): { Component: React.LazyExoticComponent<T>; preload: () => Promise<{ default: T }> } {
  return {
...
export const dashboardPage = createLazyPage(() => import('@/pages/DashboardPage'))
export const desarquivamentosPage = createLazyPage(() => import('@/pages/DesarquivamentosPage'))
export const novoDesarquivamentoPage = createLazyPage(() => import('@/pages/NovoDesarquivamentoPage'))
export const detalhesDesarquivamentoPage = createLazyPage(() => import('@/pages/DetalhesDesarquivamentoPage'))
export const editDesarquivamentoPage = createLazyPage(() => import('@/pages/EditDesarquivamentoPage'))
export const usuariosPage = createLazyPage(() => import('@/pages/usuarios/UsuariosPage'))
export const novoUsuarioPage = createLazyPage(() => import('@/pages/usuarios/NovoUsuarioPage'))
export const editarUsuarioPage = createLazyPage(() => import('@/pages/usuarios/EditarUsuarioPage'))
export const configuracoesPage = createLazyPage(() => import('@/pages/ConfiguracoesPage'))
...
export const novaTarefaPage = createLazyPage(() => import('@/pages/tarefas/NovaTarefaPage'))
export const detalheTarefaPage = createLazyPage(() => import('@/pages/tarefas/DetalheTarefaPage'))
...
export const bancoVestigiosPage = createLazyPage(() => import('@/pages/BancoVestigiosPage'))

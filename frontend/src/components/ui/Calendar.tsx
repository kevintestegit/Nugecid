...
export const Calendar = React.forwardRef<HTMLDivElement, CalendarProps>(
  ({ className, classNames, showOutsideDays = true, locale = ptBR, ...props }, ref) => (
    <DayPicker
      ref={ref}
      ...
      classNames={{
        months: 'flex flex-col space-y-1.5 sm:flex-row sm:space-x-1.5 sm:space-y-0',
        month: 'space-y-1.5',
      ...
      components={{
        IconLeft: props =>
          <span {...props} aria-hidden className="inline-flex h-4 w-4 items-center justify-center">&#x2039;</span>,
        IconRight: props =>
          <span {...props} aria-hidden className="inline-flex h-4 w-4 items-center justify-center">&#x203A;</span>,
      }}
      {...props}

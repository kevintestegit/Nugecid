...
interface EditarPastaModalProps {
  ...
  pasta: Pasta | null
  onClose: () => void
  onSubmit: (data: { nome: string; descricao: string; tags: string[] }) => Promise<void> | void
        ...
        <Card className="relative w-full max-w-lg mx-4 pointer-events-auto">
          ...
          <CardContent>
            <form className="space-y-4" onSubmit={handleSubmit}>
              <div>
                <label htmlFor="editar-nome" className="block text-sm font-medium text-muted-foreground mb-1">
                  Nome
                </label>
                <Input
                  id="editar-nome"
              ...
              <div>
                <label htmlFor="editar-descricao" className="block text-sm font-medium text-muted-foreground mb-1">
                  Descrição
                </label>
                <Textarea
                  id="editar-descricao"
              ...
              <div>
                <label htmlFor="editar-tags" className="block text-sm font-medium text-muted-foreground mb-1">

...
const desarquivamentoSchema = z.object({
  ...
  finalidadeDesarquivamento: z
    .string()
    .max(2000, "A finalidade deve ter no máximo 2000 caracteres")
    .optional(),
  ...
  numeroOficio: z
    .string()
    .max(255, "O número do ofício deve ter no máximo 255 caracteres")
    .optional(),
  instituto: z
    .string()
    .max(255, "O instituto deve ter no máximo 255 caracteres")
    .optional(),
  requerente: z
    .string()
...
const DesarquivamentoForm: React.FC<DesarquivamentoFormProps> = ({
  ...
  const defaultValues = React.useMemo((): Partial<DesarquivamentoFormData> => {
    ...
    return {
      ...(data as unknown as Partial<DesarquivamentoFormData>),
      tipoDesarquivamento:
        (data.tipoDesarquivamento as TipoDesarquivamento) || undefined, // Evita string vazia
      dataSolicitacao: data.dataSolicitacao
        ? new Date(data.dataSolicitacao as string | number | Date)
        : new Date(),
      dataDesarquivamentoSAG: data.dataDesarquivamentoSAG
        ? new Date(data.dataDesarquivamentoSAG as string | number | Date)
        : undefined,
      dataDevolucaoSetor: data.dataDevolucaoSetor
        ? new Date(data.dataDevolucaoSetor as string | number | Date)
        : undefined,
      solicitacaoProrrogacao: (data.solicitacaoProrrogacao as boolean) || false,
      solicitacaoProrrogacaoTexto:
        (data.solicitacaoProrrogacaoTexto as string) || "",
      dadosAdicionais: (data.dadosAdicionais as string) || "",
      urgente: (data.urgente as boolean) || false,
      numeroOficio: (data.numeroOficio as string) || "",
      instituto: (data.instituto as string) || "",
      requerente: (data.requerente as string) || "",
    };
  }, [initialData]);
    ...
    >
      <Card className="glass-panel">
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          <div className="space-y-2">
            <Label htmlFor="tipoDesarquivamento">
            ...
            <Controller
              ...
              render={({ field }) => (
                <Select value={field.value} onValueChange={field.onChange}>
                  <SelectTrigger
                    className={
                      errors.tipoDesarquivamento ? "border-destructive" : ""
                    }
                  >
            ...
            {errors.tipoDesarquivamento && (
              <p className="text-sm text-destructive">
                {errors.tipoDesarquivamento.message}
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            <Label htmlFor="numeroNicLaudoAuto">
              Nº DO CIN/NIC/LAUDO/INFORMAÇÃO TÉCNICA
            </Label>
            <Input
          ...
          <div className="space-y-2">
            <Label htmlFor="dataDesarquivamentoSAG">
          ...
          <div className="space-y-2">
            <Label htmlFor="dataDevolucaoSetor">
          ...
          <div className="space-y-2 md:col-span-2">
            <Label htmlFor="dadosAdicionais">Observações</Label>
            <Textarea
              id="dadosAdicionais"
        ...
        <CardContent className="grid grid-cols-1 md:grid-cols-2 gap-6">
          ...
          <div className="space-y-2">
            ...
            <Controller
              ...
              render={({ field }) => (
                ...
                >
                  <SelectTrigger
                    className={errors.instituto ? "border-destructive" : ""}
                  >
          ...
          <div className="space-y-2">
            ...
            {errors.setorDemandante && (
              <p className="text-sm text-destructive">
                {errors.setorDemandante.message}
              </p>
            )}
          </div>
          ...
          <div className="space-y-2">
            ...
            {errors.servidorResponsavel && (
              <p className="text-sm text-destructive">
                {errors.servidorResponsavel.message}
              </p>
            )}
          </div>
        </CardContent>
      ...
      <Card className="glass-panel">
        ...
        <CardContent className="space-y-4">
          <div className="space-y-2">
            <Label htmlFor="finalidadeDesarquivamento">
            ...
            <Textarea
              ...
              className={
                errors.finalidadeDesarquivamento ? "border-destructive" : ""
              }
              rows={4}
            />
            {errors.finalidadeDesarquivamento && (
              <p className="text-sm text-destructive">
                {errors.finalidadeDesarquivamento.message}
              </p>
            )}
          </div>
          <div className="flex items-center space-x-2">
            ...
            />
            <Label htmlFor="solicitacaoProrrogacao">
          ...
          {watch("solicitacaoProrrogacao") && (
            <div className="space-y-2">
              <Label htmlFor="solicitacaoProrrogacaoTexto">
                Texto da Solicitação de Prorrogação
              </Label>
              <Textarea

      ...
      <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
        ...
        <div className="space-y-2">
          ...
          <ValidatedInput
            ...
            placeholder={
              mode === "create" ? "Digite a senha" : "Nova senha (opcional)"
            }
            disabled={isLoading}
        ...
        <div className="space-y-2">
          ...
          <select
            ...
            className={`w-full px-3 py-2 border rounded-md focus:ring-2 focus:ring-blue-500 focus:border-blue-500 transition-colors ${
              errors.role ? "border-red-300" : "border-border"
            }`}
            disabled={isLoading}
          >
            ...
            <div className="flex items-center space-x-4">
              <label className="flex items-center">
                <input
                  ...
                  disabled={isLoading}
                />
                <span className="ml-2 text-sm text-foreground/90">Ativo</span>
              </label>
              <label className="flex items-center">
                <input
                  type="radio"
                  ...
                  disabled={isLoading}
                />
                <span className="ml-2 text-sm text-foreground/90">Inativo</span>
              </label>
            </div>
          </div>
        )}

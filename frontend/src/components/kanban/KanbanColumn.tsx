  ...
  return (
    <div
      className={cn(
        ...
        density === 'compact' ? 'min-w-[260px] max-w-[260px]' : 'min-w-[280px] max-w-[280px]'
      )}
    >
      {/* Header da coluna */}
      <div className="flex items-center justify-between mb-3 px-1">
        <div className="flex items-center gap-2">
          <h3 className="text-sm font-semibold text-gray-700 dark:text-gray-200">{coluna.nome}</h3>
      ...
      <div
        ...
        className={cn(
          ...
          isOver && 'bg-blue-50/50 dark:bg-blue-900/10 border-2 border-blue-200 border-dashed',

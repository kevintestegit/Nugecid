...
export const PrazoBadge: React.FC<PrazoBadgeProps> = ({ 
  ...
  const Icon = prazoInfo.status === PrazoStatus.ATRASADO ? AlertCircle : Calendar;

  return (
    <div className={`inline-flex items-center gap-1 rounded-full border font-medium ${sizeClasses} ${bgColor}`}>

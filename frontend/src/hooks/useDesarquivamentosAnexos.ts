...
import type { DesarquivamentoAnexo } from "@/types";

export type { DesarquivamentoAnexo };
...
export const useDesarquivamentosAnexos = (
  ...
  return useQuery({
    ...
    queryFn: async () => {
      const response = await apiService.getDesarquivamentosAnexos(
        numericId,
        tipoAnexo,
      );
...
export const useUploadDesarquivamentoAnexo = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiService.uploadDesarquivamentoAnexo(
        desarquivamentoId,
        file,
        descricao,
        tipoAnexo,
    ...
    onSuccess: (result, variables) => {
      ...
      queryClient.invalidateQueries({
        queryKey: [
          DESARQUIVAMENTOS_ANEXOS_QUERY_KEY,
          variables.desarquivamentoId,
          variables.tipoAnexo || "desarquivamento",
        ],
      });
    },
  });
...
export const useUpdateDesarquivamentoAnexo = () => {
  ...
  return useMutation({
    mutationFn: ({
      ...
      apiService.updateDesarquivamentoAnexo(
        desarquivamentoId,
        anexoId,
        descricao,
      ),

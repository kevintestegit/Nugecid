...
- [x] **Step 1: Testar resposta paginada no Banco de Vestígios**
...
- [x] **Step 2: Testar redirecionamento após salvar**
...
- [x] **Step 4: Restaurar navegação e filtros**
...
- [x] **Step 5: Confirmar testes verdes**
...
- [x] **Step 1: Executar qualidade completa**
